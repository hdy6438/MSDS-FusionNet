...
from model.FeatureFusion import AttentionFusion
...
class NinaProNetNoMAM(nn.Module):
    def __init__(self, d_model, num_class, branch_channel, mutil_mode=False, decision_mlp=True, deep_sup=True,
        ...
        self.FeatureFusion = AttentionFusion(branch_channel=branch_channel, cross_subject=cross_subject)
